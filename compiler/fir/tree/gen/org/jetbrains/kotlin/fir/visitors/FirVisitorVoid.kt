...
abstract class FirVisitorVoid : FirVisitor<Unit, Nothing?>() {
    ...
    open fun visitDefinitelyNotNullTypeRef(definitelyNotNullTypeRef: FirDefinitelyNotNullTypeRef) {
        visitElement(definitelyNotNullTypeRef)
    }
    ...
    final override fun visitDefinitelyNotNullTypeRef(definitelyNotNullTypeRef: FirDefinitelyNotNullTypeRef, data: Nothing?) {
        visitDefinitelyNotNullTypeRef(definitelyNotNullTypeRef)
    }
